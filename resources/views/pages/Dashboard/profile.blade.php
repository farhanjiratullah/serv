                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            <div class="flex items-center mt-1">
                                                @if ($user->DetailUser->photo)
                                                    <img src="{{ Storage::url($user->DetailUser->photo) }}"
                                                ...
                                                <a href="{{ route('member.delete.photo.profile', $user->DetailUser->id) }}"
                                                    type="button"
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3 col-span-6">
                                            <label for="name"
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <textarea placeholder="Enter your biography here.." type="text" name="biography"
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($user->ExperienceUsers as $key => $item)

                            ...
                            <div class="grid gap-5 md:grid-cols-12">
                                            ...
                                            <div class="flex mt-2 flex-nowrap">
                                                ...
                                                @foreach ($service->Thumbnails as $thumbnail)
                                                    <img :class="{'border-4 border-serv-button': active === {{ $thumbnail->id }} }"
                                                        ...
                                                        alt="{{ $service->title }}"
                                                        class="inline-block mr-2 rounded-lg cursor-pointer w-24 object-cover"
                                                        loading="lazy">
                                                @endforeach
                                            ...
                                            <div class="leading-8 text-md">
                                                ...
                                                @if ($service->User->DetailUser->contact_number)
                                                    <p class="mb-4 font-medium">
                                                        ...
                                                        {{ $service->User->DetailUser->contact_number }}
                                                    </p>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                <div class="p-4 lg:col-span-6 md:col-span-12">
                                    ...
                                    @forelse ($service->Taglines as $tagline)
                                        <button type="button"
                                            class="inline-flex justify-center px-3 py-2 mb-2 text-xs font-medium text-gray-700 bg-gray-100 border border-transparent rounded-lg hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">{{ $tagline->tagline }}</button>
                                    @empty

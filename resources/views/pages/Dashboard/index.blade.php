                    ...
                    <div @click.away="open = false" class="relative z-10 hidden mt-5 lg:block" x-data="{ open: false }">
                        <button
                            ...
                            @if (Auth::user()->DetailUser->photo)
                                <img src="{{ Storage::url(Auth::user()->DetailUser->photo) }}"
                                    alt="{{ Auth::user()->name }}" class="inline w-12 h-12 mr-3 rounded-full"
                                    loading="lazy">
                            @else
                                    ...
                                    <tr class="text-gray-700">
                                        <td class="w-1/3 px-1 py-5">
                                            <div class="flex items-center text-sm">
                                                ...
                                                <div>
                                                    <p class="font-medium text-black">{{ $order->OrderBuyer->name }}</p>
                                        ...
                                        <td class="px-1 py-5 text-xs text-red-500">
                                            ...
                                            {{ \Carbon\Carbon::parse($order->expired)->format('d F Y') }}
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center">
                                            <p class="mt-5">Data empty.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>

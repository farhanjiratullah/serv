                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="delivery_time" name="delivery_time" autocomplete="delivery_time"
                                                ...
                                                <option value="2" {{ old('delivery_limit') == 2 ? 'selected' : '' }}>2
                                                    Hari
                                                </option>
                                                <option value="4" {{ old('delivery_limit') == 4 ? 'selected' : '' }}>4
                                                    Hari
                                                </option>
                                                <option value="8" {{ old('delivery_limit') == 8 ? 'selected' : '' }}>8
                                                    Hari
                                                </option>
                                                <option value="16" {{ old('delivery_limit') == 16 ? 'selected' : '' }}>16
                                                    Hari</option>
                                                <option value="32" {{ old('delivery_limit') == 32 ? 'selected' : '' }}>32
                                                    Hari</option>
                                            </select>
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="revision_limit" name="revision_limit" autocomplete="revision_limit"
                                                ...
                                                <option value="2" {{ old('revision_limit') == 2 ? 'selected' : '' }}>2
                                                    Revisi</option>
                                                <option value="5" {{ old('revision_limit') == 5 ? 'selected' : '' }}>5
                                                    Revisi</option>
                                                <option value="7" {{ old('revision_limit') == 7 ? 'selected' : '' }}>7
                                                    Revisi</option>
                                                <option value="10" {{ old('revision_limit') == 10 ? 'selected' : '' }}>10
                                                    Revisi</option>
                                                <option value="12" {{ old('revision_limit') == 12 ? 'selected' : '' }}>12
                                                    Revisi</option>
                                            </select>
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addAdvantagesRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Keunggulan Kamu" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
    ...
    <script type="text/javascript">
        ...
        $("#addServicesRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Keunggulan Service" type="text" name="advantage-service[]" id="advantage-service" autocomplete="advantage-service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';

            ...
            <div class="hidden lg:flex lg:items-center lg:w-auto w-full lg:ml-auto lg:mr-auto flex-wrap items-center text-base justify-center"
                ...
                <nav
                    ...
                    <a href="{{ route('explore.landing') }}"
                        class="block nav-link {{ request()->is('explore') ? 'active font-medium' : 'text-serv-text' }}">Explore</a>
                    ...
                    @auth
                        ...
                        <a href="#" class="block lg:hidden nav-link text-serv-text"
                    ...
                    <button @click="open = !open"
                        ...
                        @if (Auth::user()->DetailUser->photo)
                            <img src="{{ Storage::url(Auth::user()->DetailUser->photo) }}"
                                alt="{{ Auth::user()->name }}" class="inline ml-3 h-12 w-12 rounded-full" loading="lazy">
                        @else

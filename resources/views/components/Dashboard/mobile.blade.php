<aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 overflow-y-auto bg-white md:hidden" x-show="isSideMenuOpen" x-transition:enter="transition ease-in-out duration-150" x-transition:enter-start="opacity-0 transform -translate-x-20" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in-out duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 transform -translate-x-20" @click.away="closeSideMenu" @keydown.escape="closeSideMenu" aria-label="aside">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="{{ route('member.dashboard.index') }}">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                ...
                @endif
                <a class="inline-flex items-center w-full text-sm @if(request()->is('member/dashboard')) font-medium text-gray-800 @else font-light @endif transition-colors duration-150 hover:text-gray-800" href="{{ route('member.dashboard.index') }}">
        ...
        <ul>
            <li class="relative px-6 py-3">
                @if (request()->is('member/service', 'member/service/*'))
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg" aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm @if(request()->is('member/service', 'member/service/*')) font-medium text-gray-800 @else font-light @endif transition-colors duration-150 hover:text-gray-800" href="{{ route('member.service.index') }}">
            ...
            <li class="relative px-6 py-3">
                @if (request()->is('member/request', 'member/request/*'))
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg" aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm @if(request()->is('member/request', 'member/request/*')) font-medium text-gray-800 @else font-light @endif transition-colors duration-150 hover:text-gray-800" href="{{ route('member.request.index') }}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="relative px-6 py-3">
                @if (request()->is('member/order', 'member/order/*'))
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg" aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm @if(request()->is('member/order', 'member/order/*')) font-medium text-gray-800 @else font-light @endif transition-colors duration-150 hover:text-gray-800" href="{{ route('member.order.index') }}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="relative px-6 py-3">
                @if (request()->is('member/profile'))
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg" aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm @if(request()->is('member/profile')) font-medium text-gray-800 @else font-light @endif transition-colors duration-150 hover:text-gray-800" href="{{ route('member.profile.index') }}">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

...
<aside class="z-20 flex-shrink-0 hidden w-64 overflow-y-auto bg-white md:block" aria-label="aside">
    <div class="text-serv-bg">
        <div class="" href="{{ route('member.dashboard.index') }}">
        ...
        <div class="flex items-center pt-8 pl-5 space-x-2 border-t border-gray-100">
            ...
            @if (Auth::user()->DetailUser->photo)
                <img src="{{ Storage::url(Auth::user()->DetailUser->photo) }}" alt="{{ Auth::user()->name }}"
                    class="object-cover object-center mr-1 rounded-full w-14 h-14" loading="lazy">
            @else
                <svg class="object-cover object-center w-14 h-14 mr-1 rounded-full text-gray-300" fill="currentColor"
                    viewBox="0 0 24 24">
                    <path
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                ...
                @endif
                <a class="inline-flex items-center w-full text-sm @if (request()->is('member/dashboard')) font-medium text-gray-800 @else font-light @endif transition-colors duration-150 hover:text-gray-800 "
        ...
        <ul>
            <li class="relative px-6 py-3">
                @if (request()->is('member/service', 'member/service/*'))
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg"
                        aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm @if (request()->is('member/service', 'member/service/*')) font-medium text-gray-800 @else font-light @endif transition-colors duration-150 hover:text-gray-800"
                    ...
                    <span
                        class="inline-flex items-center justify-center px-3 py-2 ml-auto text-xs font-bold leading-none text-green-500 rounded-full bg-serv-green-badge">{{ Auth::user()->Services->count() }}</span>

                </a>
            </li>
            <li class="relative px-6 py-3">
                @if (request()->is('member/request', 'member/request/*'))
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg"
                        aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm @if (request()->is('member/request', 'member/request/*')) font-medium text-gray-800 @else font-light @endif transition-colors duration-150 hover:text-gray-800"
            ...
            <li class="relative px-6 py-3">
                @if (request()->is('member/order', 'member/order/*'))
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg"
                        aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm @if (request()->is('member/order', 'member/order/*')) font-medium text-gray-800 @else font-light @endif transition-colors duration-150 hover:text-gray-800"
            ...
            <li class="relative px-6 py-3">
                @if (request()->is('member/profile'))
                    <span class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg bg-serv-bg"
                        aria-hidden="true"></span>
                @endif
                <a class="inline-flex items-center w-full text-sm @if (request()->is('member/profile')) font-medium text-gray-800 @else font-light @endif transition-colors duration-150 hover:text-gray-800"

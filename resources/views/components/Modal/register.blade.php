        ...
        <form action="{{ route('register') }}" method="post">
            ...
            <div class="relative p-6 flex-auto mx-10">
                <div class="mb-4">
                    ...
                    <input class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" id="name" type="text" placeholder="Your name" name="name" required autofocus>
                ...
                <div class="mb-4">
                    ...
                    <input class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" id="email" type="email" placeholder="name@domain.com" name="email" required>
                ...
                <div>
                    ...
                    <input class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs mb-3" id="password" type="password" placeholder="At least 8 characters" name="password" required autocomplete="new-password">
                ...
                <div>
                    ...
                    <input class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs mb-3" id="password_confirmation" type="password" placeholder="At least 8 characters" name="password_confirmation" required autocomplete="off">

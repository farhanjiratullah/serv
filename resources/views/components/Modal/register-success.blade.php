    ...
    <div class="border-0 rounded-xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
        ...
        <form action="index.php" method="GET">
            ...
            <div class="px-6 pb-6 rounded-b-xl mx-10">
                ...
                <a href="{{ route('explore.landing') }}" class="block text-center bg-serv-button text-white text-lg py-3 px-12 my-2 rounded-lg w-full" type="submit">
                    Find Services
                </a>
                <a href="{{ route('member.dashboard.index') }}" class="block text-center text-serv-text text-lg py-3 px-12 my-2 rounded-lg w-full" type="submit">
                    My Dashboard
                </a>
            </div>
        </form>
